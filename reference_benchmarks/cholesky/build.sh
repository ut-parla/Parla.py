...
# conda create -n magma_test -c conda-forge magma python=3.7 scikit-build cython
...
python -c "import cholesky_bench; cholesky_bench.bench_cholesky()" | tee ../../../benchmark_results.txt
popd
rm -rf _skbuild
